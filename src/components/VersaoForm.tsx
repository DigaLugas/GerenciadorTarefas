...
function VersaoForm({ initialData, onSave, onCancel }: VersaoFormProps) {
  const [versao, setVersao] = useState<Versao>(
    initialData || {
      ...
      observacoes: '',
      estadoGmud: 'não iniciado'  // Valor padrão para o estado da GMUD
    }
  );
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
        ...
        <div>
          ...
          >
            ...
            <option value="pendente de acordo">Pendente de acordo</option>
            <option value="pendente permissão de Change">Pendente permissão de Change</option>
          </select>
        </div>
      </div>
